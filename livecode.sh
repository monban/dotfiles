...
QUALITY="veryfast" 
AUDIO_RATE="44100"
URI=rtmp://usmedia3.livecoding.tv:1935/livecodingtv/$LIVECODING_STREAM_KEY
...
ffmpeg \
	...
	-pix_fmt yuv420p -vcodec libx264 -preset $QUALITY -maxrate $CBR -bufsize $CBR \
	-s $OUTRES -threads $THREADS -acodec mp3 -af "highpass=f=100, lowpass=f=3000" -t 10 \
	"$URI"
xrandr --auto
